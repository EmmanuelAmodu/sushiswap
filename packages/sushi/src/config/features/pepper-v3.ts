 ...
 */
// export const TICK_SPACINGS: { [_amount in PepperV3FeeAmount]: number } = {
//   [PepperV3FeeAmount.LOWEST]: 1,
//   [PepperV3FeeAmount.LOW]: 10,
//   [PepperV3FeeAmount.MEDIUM]: 60,
//   [PepperV3FeeAmount.HIGH]: 200,
// }

// PEPPER
export const PEPPER_V3_FACTORY_ADDRESS: Record<PepperV3ChainId, `0x${string}`> =
  {
...
export const PEPPER_V3_INIT_CODE_HASH: Record<PepperV3ChainId, `0x${string}`> =
  {
...
export const PEPPER_V3_POSTIION_MANAGER: Record<
  PepperV3ChainId,
  `0x${string}`
> = {
...
export const PEPPER_V3_TICK_LENS: Record<PepperV3ChainId, `0x${string}`> = {
...
export const PEPPER_V3_SUPPORTED_CHAIN_IDS = [
...
export const PepperV3ChainIds = PEPPER_V3_SUPPORTED_CHAIN_IDS

export type PepperV3ChainId = (typeof PEPPER_V3_SUPPORTED_CHAIN_IDS)[number]

export const isPepperV3ChainId = (
  chainId: ChainId,
): chainId is PepperV3ChainId =>
  PEPPER_V3_SUPPORTED_CHAIN_IDS.includes(chainId as PepperV3ChainId)
